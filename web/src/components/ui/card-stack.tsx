  ...
  return (
    ...
    >
      <motion.div
        style={{
          scale,
          top: `calc(-5vh + ${i * 25 + 25}px)`,
        }}
        className="relative -top-1/4 flex h-[70vw] md:h-[450px] w-[95vw] md:w-[800px] origin-top flex-col overflow-hidden rounded-3xl md:rounded-[2.5rem]"
      >
